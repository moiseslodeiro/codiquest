import{s as H}from"./scheduler.38f5b73a.js";import{S as I,i as L,r as g,u as v,v as h,d as C,t as _,w as b,g as f,s as w,h as $,x,c as F,a as u,f as m,m as P,n as k}from"./index.33e8e8ec.js";import{C as T}from"./Code.2fe2a1f6.js";import"./paths.3b9e6dc4.js";import{P as z}from"./File.svelte_svelte_type_style_lang.9085771d.js";import{F as S}from"./File.c8ff549e.js";function A(l){let e;return{c(){e=P("questions.forEach((_, i) => levels.push({ question: i, title: `Pregunta ${i + 1}` }));\n")},l(a){e=k(a,"questions.forEach((_, i) => levels.push({ question: i, title: `Pregunta ${i + 1}` }));\n")},m(a,t){u(a,e,t)},d(a){a&&m(e)}}}function B(l){let e;return{c(){e=P(`import Choose from '$lib/templates/Choose.svelte';
