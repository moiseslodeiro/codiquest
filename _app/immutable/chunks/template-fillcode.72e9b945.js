import{s as H}from"./scheduler.ddf3e249.js";import{S as A,i as N,r as j,u as k,v as C,d as x,t as L,w as T,g as w,s as b,h as q,x as O,c as h,j as S,f as o,k as U,a as l,m as E,n as P}from"./index.3ca611f3.js";import{P as I}from"./File.svelte_svelte_type_style_lang.d0caee9a.js";import{M as G}from"./Message.069052d5.js";import{b as K}from"./paths.8765ca36.js";import{F as Q}from"./File.3c661f67.js";function D(r){let a;return{c(){a=E("Ten en cuenta que no hay una validación de código como tal, sino que se comprueba que el código original (eliminando las coincidencias `$x$`) sea el mismo que el resultante tras haber rellenado los huecos.")},l(n){a=P(n,"Ten en cuenta que no hay una validación de código como tal, sino que se comprueba que el código original (eliminando las coincidencias `$x$`) sea el mismo que el resultante tras haber rellenado los huecos.")},m(n,t){l(n,a,t)},d(n){n&&o(a)}}}function R(r){let a;return{c(){a=E(`<script>
