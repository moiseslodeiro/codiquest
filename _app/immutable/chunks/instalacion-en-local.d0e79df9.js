import{s as st}from"./scheduler.ddf3e249.js";import{S as lt,i as rt,r as m,u as f,v as $,d as v,t as g,w as h,g as i,s as d,h as c,x as u,c as p,j as Ee,f as o,k as it,a as s,m as _,n as w}from"./index.3ca611f3.js";import{C as X}from"./Code.e06be4ef.js";import{M as Me}from"./Message.069052d5.js";import{M as dt}from"./ModalImage.9abc2c0f.js";import{P as ct}from"./File.svelte_svelte_type_style_lang.d0caee9a.js";import"./paths.8765ca36.js";function pt(r){let n;return{c(){n=_("Se asume que para la instalación local (a diferencia de la remota) se presuponen ciertos conocimientos sobre cómo manejar una terminal, clonar un repositorio, etc.")},l(a){n=w(a,"Se asume que para la instalación local (a diferencia de la remota) se presuponen ciertos conocimientos sobre cómo manejar una terminal, clonar un repositorio, etc.")},m(a,l){s(a,n,l)},d(a){a&&o(n)}}}function ut(r){let n;return{c(){n=_(`git clone git@github.com:moiseslodeiro/codiquest.git
