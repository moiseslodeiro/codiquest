...
<BreadCrumb linksTo="about" title="Acerca de" />
<div class="container md:mx-auto py-2">
  <h1 class="text-2xl mt-2">Acerca de</h1>
  <article class="mt-2 leading-relaxed text-lg">
    <p>
      ...
      seguir jugando con tecnología que desconoces? Así es como con azúcar, especias, algún
      contratiempo y muchos commits bonitos (que eran los ingredientes para crear una app perfecta),
      nació <b>CodiQuest</b>.
    </p>

    <img class="float-left w-32 mr-2 pt-2" src="{base}/img/favicon.webp" alt="Hola! Soy Codi :-)" />

    <p class="mt-2">
      CodiQuest es una plataforma de creación de contenido estático que parte de la idea de crear
      una aplicación para la creación de tutoriales y cuestionarios que ayuden a otras personas a
      asimilar conceptos de tecnología y desarrollo de una manera divertida,
      <span class="underline decoration-2 decoration-pink-500 underline-offset-4"
        ><a href="https://github.com/moiseslodeiro/codiquest" target="_blank">libre</a></span
      >
      y
      <span class="underline decoration-2 decoration-blue-500 underline-offset-4">gratuita</span>.
      Nace en 2023 a partir de un pet project desarrollado principalmente en Svelte con Javascript
      Vanilla. De momento la aplicación no almacena datos del usuario ni cookies ni nada parecido
      (de hecho, si vuelves atrás en un nivel, ¡podrás volverlo a resolver! 😃)
    </p>
    <p class="mt-2">
      El código es totalmente libre y puedes montar una plataforma similar con pocos clics. Revisa
      la información del repositorio en <a
        class="underline decoration-2 decoration-slate-500 underline-offset-4"
        href="https://github.com/moiseslodeiro/codiquest">Github</a
      >
      para más información. Si quieres conocer más sobre el mi, el creador, puedes seguirme en
      <a
        class="underline decoration-2 decoration-blue-500 underline-offset-4"
        href="https://twitter.com/MoisesLodeiro">𝕏 (twitter)</a
      >, en
      <a
        class="underline decoration-2 decoration-blue-500 underline-offset-4"
        href="https://www.linkedin.com/in/moiseslodeiro/">LinkedIn</a
      > o invitarme a una cerveza si me ves en persona 🍻.
    </p>
    <h2 class="text-xl mt-2">Contacto</h2>

    <p class="mt-2">
      Si tienes dudas, sugerencias, quejas o tienes la imperiosa necesidad de hacerme un bizum,
      puedes contactar conmigo (aparte de por <a
        class="underline decoration-2 decoration-blue-500 underline-offset-4"
        href="https://twitter.com/MoisesLodeiro">𝕏</a
      >
      y
      <a
        class="underline decoration-2 decoration-blue-500 underline-offset-4"
      ...
      <a
        class="underline decoration-2 decoration-rose-500 underline-offset-4"
        href="mailto:codiquest@gmail.com">codiquest@gmail.com</a
      >
      o seguir este proyecto por
      <a
        class="underline decoration-2 decoration-blue-500 underline-offset-4"
        href="https://twitter.com/CodiQuest">Twitter</a
      >.
    </p>
  </article>
</div>
...
<div class="container md:mx-auto py-2">
  <h2 class="text-xl mb-2">Componentes</h2>
...
<div class="container md:mx-auto py-2">
  <h2 class="text-xl mt-2">Versión actual</h2>
  <p>
    Build id: <a
      target="_blank"
      href="https://github.com/moiseslodeiro/codiquest/commit/{__COMMIT_HASH__}"
      >{__COMMIT_HASH__}</a
    >
  </p>
</div>
